(function (e) {
  ...
  "1ab2": function (e, t, n) {
    ...
    t.default = function (e) {
      ...
      if (o = (0, a.default)((0, a.default)({}, o), i(u, e, t)), "DOWNLOAD" === n)(0, r.isUndefined)(t.timeout) ? (0, r.isUndefined)(e.timeout) || (o.timeout = e.timeout) : o.timeout = t.timeout;
      else if ("UPLOAD" === n) {
    ...
    t.filterDataList = function (e) {
      ...
      var n = r.default.shuffle(t.arr),
        o = i.map((function (e, t) {
          return i.length - 1 === t ? (0, a.default)({}, e) : (0, a.default)((0, a.default)({}, e), {}, {
            text: n[t]
          })
        }));
      return {
