(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-index-index"], {
    "001b": function (e, t, i) {
        ...
        var a = i("24fb");
        t = a(!1), t.push([e.i, '@charset "UTF-8";\r\n/**\r\n * 这里是uni-app内置的常用样式变量\r\n *\r\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\r\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\r\n *\r\n */\r\n/**\r\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\r\n *\r\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\r\n */\r\n/* 颜色变量 */\r\n/* 行为相关颜色 */\r\n/* 文字基本颜色 */\r\n/* 背景颜色 */\r\n/* 边框颜色 */\r\n/* 尺寸变量 */\r\n/* 文字尺寸 */\r\n/* 图片尺寸 */\r\n/* Border Radius */\r\n/* 水平间距 */\r\n/* 垂直间距 */\r\n/* 透明度 */\r\n/* 文章场景相关 */#particles[data-v-6ac0b7df]{position:absolute;width:100%;height:100%;margin-top:-120px;background-repeat:no-repeat;background-size:cover;background-position:50% 50%}', ""]), e.exports = t
    }, "4be7": function (e, t, i) {
        "use strict";
        ...
        var a = i("24fb");
        t = a(!1), t.push([e.i, '@charset "UTF-8";\r\n/**\r\n * 这里是uni-app内置的常用样式变量\r\n *\r\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\r\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\r\n *\r\n */\r\n/**\r\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\r\n *\r\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\r\n */\r\n/* 颜色变量 */\r\n/* 行为相关颜色 */\r\n/* 文字基本颜色 */\r\n/* 背景颜色 */\r\n/* 边框颜色 */\r\n/* 尺寸变量 */\r\n/* 文字尺寸 */\r\n/* 图片尺寸 */\r\n/* Border Radius */\r\n/* 水平间距 */\r\n/* 垂直间距 */\r\n/* 透明度 */\r\n/* 文章场景相关 */.hot[data-v-4cff2aef]{line-height:%?33?%;width:%?220?%;text-align:center;font-size:10px;font-weight:700;background-color:#dd001b;-webkit-transform:rotate(-50deg);transform:rotate(-50deg);position:absolute;left:-20px}.bottom-bg[data-v-4cff2aef]{position:fixed;z-index:999;bottom:0;left:0;right:0;height:44px;}.navbar[data-v-4cff2aef] .u-navbar__content{background-color:initial!important;}.particles[data-v-4cff2aef]{position:fixed;width:100%;height:100vh}.btn[data-v-4cff2aef]{overflow:hidden;min-height:%?110?%;position:relative;display:flex;flex-direction:row-reverse;align-items:center;margin-bottom:%?30?%;z-index:1;position:relative;font-size:16px;color:#fff;padding:%?35?% %?20?%;outline:none;border:%?1?% solid hsla(0,0%,100%,.1);box-shadow:#0029ef 2px 2px 14px 0px;border-radius: 10px;}.my-text[data-v-4cff2aef]{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.active[data-v-4cff2aef]{transition:all .75s ease-in-out;-webkit-transform-origin:center;transform-origin:center;-webkit-transform:scale(1.75);transform:scale(1.75);opacity:0}.body[data-v-4cff2aef]{left:0;top:0;right:0;background-color: #9acafc;bottom:0;display:flex;align-items:center;justify-content:center}.main[data-v-4cff2aef]{width:%?560?%;margin-top:%?120?%;}.tip-box[data-v-4cff2aef]{margin-bottom:%?15?%;color:#333;width:70vw;border-radius:%?20?%;display:flex;justify-content:space-between;align-items:center;padding:%?20?%;background-color:hsla(0,0%,100%,.5);-webkit-backdrop-filter:blur(%?18?%);backdrop-filter:blur(%?18?%);box-shadow:0 %?2?% %?24?% 0 hsla(0,0%,100%,.3)}.tip-box .tip-text[data-v-4cff2aef]{font-weight:700;color:#fff}', ""]), e.exports = t
    }, e267: function (e, t, i) {
        var a = i("9215");
        a.__esModule && (a = a.default), "string" === typeof a && (a = [[e.i, a, ""]]), a.locals && (e.exports = a.locals);
        var n = i("4f06").default;
