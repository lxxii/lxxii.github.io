(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pagesA-custom-custom"], {
    "01c2": function (t, e, n) {
        ...
        (function (t) {
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.default = void 0, n("c975");
            var o = i(n("3b74")), a = {
                name: "uniPopup",
                ...
                mounted: function () {
                    var t = this;
                    (function () {
                        var e = uni.getSystemInfoSync(), n = e.windowWidth, i = e.windowHeight, o = e.windowTop,
                            a = e.safeArea, r = (e.screenHeight, e.safeAreaInsets);
        ...
        var o = i(n("2ce3")), a = n("37dc"), r = i(n("2290")), u = (0, a.initVueI18n)(r.default), s = u.t, l = {
            name: "uniPopupDialog",
            mixins: [o.default],
            emits: ["confirm", "close"],
            props: {
        ...
        "use strict";
        n("7a82"), Object.defineProperty(e, "__esModule", {value: !0}), e.default = void 0, n("7db0"), n("d3b7"), n("b64b"), n("caad"), n("2532");
        var i = {
        ...
        var o = i(n("2909")), a = i(n("5530")), r = n("26cb"), u = n("aaec"), s = {
            data: function () {
                ...
                redomInput: function (t) {
                    ...
                    e ? this.customArr[e].text = this.$_.sample(u.data) : uni.showToast({title: "生成失败", icon: "none"})
                }, nameDialog: function () {
                    ...
                    t ? this.$refs.nameDialog.open("center") : uni.showToast({title: "数据未填写完整，请填写完后提交", icon: "none"})
                }, initData: function () {
                    var t = this;
                    if (this.editId) {
                    ...
                    this.customArr = Array(28).fill(1).map((function (t, e) {
                        return 0 == e ? {id: e + 1, text: "起点"} : 27 == e ? {id: e + 1, text: "终点"} : {
                            id: e + 1,
                            text: ""
                        }
                    }))
        ...
        (function (t) {
            ...
            var i = n("4ea4").default;
            Object.defineProperty(e, "__esModule", {value: !0}), e.default = void 0;
            var o = i(n("2909")), a = i(n("53ca")), r = i(n("5530"));
            ...
            var u = n("d643"), s = {
                ...
                props: {
                    ...
                    }, customClass: {type: String, default: ""}, onceRender: {type: Boolean, default: !1}
                },
                data: function () {
                ...
                computed: {
                    stylesObject: function () {
                        var t = (0, r.default)((0, r.default)({}, this.styles), {}, {"transition-duration": this.duration / 1e3 + "s"}),
                            e = "";
                        for (var n in t) {
                            var i = this.toLine(n);
                            e += i + ":" + t[n] + ";"
                ...
                methods: {
                    init: function () {
                        ...
                        if (this.animation) {
                            for (var i in e) try {
                                var r;
                                if ("object" === (0, a.default)(e[i])) (r = this.animation)[i].apply(r, (0, o.default)(e[i])); else this.animation[i](e[i])
                            } catch (u) {
                        ...
                        var e = this.styleInit(!1), n = e.opacity, i = e.transform;
                        "undefined" !== typeof n && (this.opacity = n), this.transform = i, this.$nextTick((function () {
                            t.timer = setTimeout((function () {
                                t.animation = (0, u.createAnimation)(t.config, t), t.tranfromInit(!1).step(), t.animation.run(), t.$emit("change", {detail: t.isShow})
                            }), 20)
                        }))
                    }, close: function (t) {
                        var e = this;
                        this.animation && this.tranfromInit(!0).step().run((function () {
                            ...
                            var t = e.styleInit(!1), n = t.opacity, i = t.transform;
                            e.opacity = n || 1, e.transform = i, e.$emit("change", {detail: e.isShow})
                        }))
                    }, styleInit: function (t) {
                        var e = this, n = {transform: ""}, i = function (t, i) {
        ...
        var i = {uniTransition: n("6416").default}, o = function () {
            var t = this, e = t.$createElement, n = t._self._c || e;
        ...
        n("7a82");
        var i = n("4ea4").default;
        Object.defineProperty(e, "__esModule", {value: !0}), e.createAnimation = function (t, e) {
            if (!e) return;
            return clearTimeout(e.timer), new u(t, e)
        }, n("caad"), n("2532"), n("99af"), n("d3b7"), n("159b");
        var o = i(n("5530")), a = i(n("d4ec")), r = i(n("bee2")), u = function () {
                function t(e, n) {
                    (0, a.default)(this, t), this.options = e, this.animation = uni.createAnimation((0, o.default)({}, e)), this.currentStepAnimates = {}, this.next = 0, this.$ = n
                }

                return (0, r.default)(t, [{
                    key: "_nvuePushAnimates", value: function (t, e) {
                        var n = this.currentStepAnimates[this.next], i = {};
                    ...
                    key: "_animateRun", value: function () {
                        ...
                        if (n) return new Promise((function (i, a) {
                            nvueAnimation.transition(n, (0, o.default)({styles: t}, e), (function (t) {
                                i()
                            }))
                        }))
                    }
                }, {
                    key: "_nvueNextAnimate", value: function (t) {
                        var e = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                            i = arguments.length > 2 ? arguments[2] : void 0, o = t[n];
                        if (o) {
                            var a = o.styles, r = o.config;
        ...
        s.concat(["opacity", "backgroundColor"], ["width", "height", "left", "right", "top", "bottom"]).forEach((function (t) {
