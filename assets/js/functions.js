...
function contact_field_validation(t, e) {
    if (void 0 !== t && t.length > 0) {
        ...
        return i.each(function() {
            ...
            n.field_object = $(this), n.message = "success", 1 != e || "" != i && null !== i && void 0 !== i || (n.message = "不能为空"), "string" == t && "" != i && null !== i && void 0 !== i ? null == i.match(/^[\u4e00-\u9fa5a-z0-9 .\-]+$/i) && (n.message = "仅支持中英文") : "email" == t && "" != i && null !== i && void 0 !== i ? null == i.match(/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/) && (n.message = "邮箱格式不正确") : "phone" == t && "" != i && null !== i && void 0 !== i && null == i.match(/^\(?\+?[\d\(\-\s\)]+$/) && (n.message = "手机号码格式不对"), a.push(n)
        }), a
    }
}
